  ...
  return (
    <Fragment>
      ...
      <div className="relative">
        {current == 1 ? (
          <div className="flex gap-2 rounded-full justify-center absolute bottom-[20px] left-[720px] ">
        ...
        {current == 3 ? (
          <div className="flex gap-2 justify-center absolute bottom-[20px] left-[720px]">
            <div className="w-3 h-3 bg-gray-500 rounded-full"></div>
